        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-in-up delay-300 mb-12 w-full justify-center lg:justify-start">
              <button className="group cursor-pointer relative px-8 py-2 bg-black text-white rounded-full text-lg font-medium overflow-hidden transition-all hover:shadow-2xl hover:shadow-purple-500/20 w-full sm:w-auto">
  ...
  <div className="w-10 h-10 rounded-full border-2 border-white bg-black text-white text-xs flex items-center justify-center font-bold">
    +40
          ...
          <div className="flex-1 w-full max-w-2xl lg:max-w-none animate-fade-in-up delay-700 relative">
            ...
            <div className="hidden lg:block absolute -bottom-12 -left-12 z-30">
              <div
            ...
            <div className="relative group">
              ...
              <div className="relative md:h-[500px] md:w-[600px] rounded-2xl bg-black border border-gray-800 aspect-video overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-12 md:left-6  md:right-6 flex items-center justify-between pointer-events-none">

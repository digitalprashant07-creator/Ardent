        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-in-up delay-300 mb-12 w-full justify-center lg:justify-start">
              <button className="group relative px-8 py-2 bg-black text-white rounded-full text-lg font-medium overflow-hidden transition-all hover:shadow-2xl hover:shadow-purple-500/20 w-full sm:w-auto">
              ...
              <button className="px-8 py-2 bg-white text-gray-900 border border-gray-200 rounded-full text-lg font-medium hover:bg-gray-50 transition-colors w-full sm:w-auto">
                View Case Studies
              </button>
            </div>
